...
import com.housecloud.housecloud.activitys_principales.RegisterActivity;

/**
 * Created by 21609143 on 31/01/2018.
 */

public class LoginActivity0 extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user != null){
                    //Intent i = new Intent(LoginActivity0.this,MenuActivity0.class);
                    //startActivity(i);
                }else{
    ...
    public void OlvidarContrasenia(View v){
        ...
        firebaseAuth.sendPasswordResetEmail(email)
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(LoginActivity0.this, "We have sent you instructions to reset your password!", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(LoginActivity0.this, "Failed to send reset email!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    private void handleFacebookAccessToken(AccessToken accessToken) {
        ...
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(!task.isSuccessful()){
                    Toast.makeText(LoginActivity0.this, R.string.not_firebase, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
